...
public class SongCrazy {
    ...
    public static void main(String[] args) {
        ...
        String[] secondline = { "That wriggled and iggled and jiggled inside her.", "How absurd to swallow a bird.",
                "Imagine that to swallow a cat.", "What a hog to swallow a dog.", "I think she's burnin'." };
        startLine("fly", ".");
        end();
        for (int x = 0; x < 5; x++) {
            startLine(animals[x], ",");
